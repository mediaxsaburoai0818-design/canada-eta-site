...
export const metadata: Metadata = {
  ...
  description: "Polityka prywatnosci serwisu eTA Kanada Online. Informacje o przetwarzaniu danych osobowych.",
};
      ...
      <section className="bg-gray-50">
        <div className="max-w-4xl mx-auto px-6 py-10">
          ...
          <p className="text-gray-600 leading-relaxed text-sm">
            ...
            danych osobowych uzytkownikow serwisu eTA Kanada Online. Szanujemy
